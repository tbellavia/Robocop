...
class ErrorMessages(Enum):
    INAPPROPRIATE_CHANNEL_CODE = "Woops, <PLACEHOLDER> on dirait que tu t'es trompé de channel. Si tu veux poster du code, je te conseille de regarder dans les salons appropriés qui te conviendront mieux."
    ...
    DELETE_INTEGER_FAIL = "<PLACEHOLDER> erreur, le deuxième paramètre doit être un entier : \n\t!del MESSAGE_NUMBER"